...
export default function NewListing() {
    ...
    const validate = () => {
        ...
        if (!form.rooms || isNaN(Number(form.rooms))) e.rooms = "Valid number required";
        ...
        return (
            <Box sx={{
                ...
                <Box sx={{textAlign: "center"}}>
                    ...
                    <Button variant="contained" onClick={() => navigate("/")} sx={{mr: 1}}>
                        View Listings
                    </Button>
                    <Button variant="outlined" onClick={() => {setForm(EMPTY_FORM); setSubmitted(false);}}>
                        Add Another
                    </Button>
                </Box>
            </Box>
        ...
        <Box sx={{
            ...
            <Paper elevation={0} sx={{
                ...
                <Box sx={{display: "flex", alignItems: "center", gap: 1.5, mb: 3}}>
                    ...
                    <Typography variant="h5" fontWeight={700}>New Property Listing</Typography>
                </Box>
                ...
                <Box sx={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, mb: 2}}>
                    ...
                    <TextField
                        label={form.status === "rent" ? "Monthly Rent (€)" : "Sale Price (€)"}
                    ...
                    <TextField
                        label="Location (e.g. Kolonaki, Athens)" fullWidth required
                    ...
                    <TextField
                        label="Area (m²)" fullWidth required type="number"
                        value={form.area} onChange={set("area")}
                        error={!!errors.area} helperText={errors.area}
                    />

                    <TextField
                        label="Rooms" fullWidth required type="number"
                        value={form.rooms} onChange={set("rooms")}
                        error={!!errors.rooms} helperText={errors.rooms}
                    />
                ...
                <Box sx={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2}}>
                    ...
                    <FormControl fullWidth>
                        ...
                        <Select value={form.ownerRole} label="Role" onChange={set("ownerRole")}>
                    ...
                    <TextField
                        ...
                        error={!!errors.ownerPhone} helperText={errors.ownerPhone}
                    />

                    <TextField
                        label="Email" fullWidth required
                        value={form.ownerEmail} onChange={set("ownerEmail")}
                        error={!!errors.ownerEmail} helperText={errors.ownerEmail}
                    />
                </Box>
